...
To obtain RightImages and start using them, please consult our
{support site}[http://support.rightscale.com/12-Guides/RightScale_101/06-Advanced_Concepts/RightImages].

== Install a Release-Quality RightLink Package
...
TODO - provide install instructions for RL 5.9 once an officially-supported
build is released.
...
regression testing after they are built, and are generally quite stable.

We cannot provide support for customers who employ nightly builds, but
they are a good way to experiment with the latest RightLink features, and
to explore upcoming enhancements and changes.
