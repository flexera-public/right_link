...
As of Aug 2014, the latest stable release of RightLink is v6.1. 

It is available for the following operating systems (64-bit binaries only):
* RHEL 6/7 (also compatible with CentOS 6/7)
* SUSE 11
* Ubuntu 12.04/14.04
