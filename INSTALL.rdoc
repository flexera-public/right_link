...
| /etc/rightscale.d                    | Static "hints" for init scripts
| /etc/rightscale.d/right_link         | Static files that allow RightLink behavior to be customized
| /var/spool/cloud                     | Cloud-provided metadata & user-data (.sh, .rb, raw formats)
...
| /opt/rightscale/bin                  | RightLink private CLI: rnac, rad, cook, ...
| /opt/rightscale/sandbox              | sandbox Ruby/RubyGems/monit binaries
| /usr/bin                             | Rightlink public CLI: rs_tag, rs_debug, ...

=== Windows Systems

| COMMON_APPDATA\RightScale\rightscale.d            | Static "hints" for system services
| COMMON_APPDATA\RightScale\rightscale.d\right_link | Static files that allow RightLink behavior to be customized
| COMMON_APPDATA\RightScale\spool\cloud             | Cloud-provided metadata & user-data (.sh, .rb, raw formats)
| COMMON_APPDATA\RightScale\RightAgent              | Persistent config files generated at startup
| COMMON_APPDATA\RightScale\right_link              | Persistent RightLink agent state
