...
require File.expand_path(File.join(File.dirname(__FILE__), '..', '..', 'scripts', 'right_script_runner'))

module RightScale
  describe RightScriptRunner do
    ...
    context 'rs_run_right_script --version' do
      it 'reports RightLink version from gemspec' do
        run_bundle_runner('--version')
        @output.join('\n').should match /rs_run_right_script \d+\.\d+\.?\d* - RightLink's RightScripts Runner \(c\) \d+ RightScale Inc/
      end
    end

    context 'rs_run_right_script --help' do
      it 'should show usage info' do
        usage = Usage.scan(File.expand_path(File.join(File.dirname(__FILE__), '..', '..', 'scripts', 'right_script_runner.rb')))
        run_bundle_runner('--help')
    ...
    context 'rs_run_right_script -i 14 -r "tag1 tag2" -s single' do
    ...
    context 'rs_run_right_script -i 14 -r "tag1 tag2"' do
    ...
    context 'rs_run_right_script -i 14 --policy SWAG' do
    ...
    context 'rs_run_right_script -i 14 --thread thread123' do
    ...
    context 'rs_run_right_script -i 14 -a 100' do
    ...
    context 'rs_run_right_script -a 1000' do
    ...
    context 'rs_run_right_script -i 14 -c /etc/etc' do
