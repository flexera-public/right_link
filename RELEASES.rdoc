...
* Newer Citrix XenServer Tools installs (>6.1) remove needed xenstore_client.exe: http://support.citrix.com/article/CTX136422. This will prevent RightLink from booting. Known affected cloud/image combinations are some Windows Server 2012R2 images on Rackspace Open Cloud.
