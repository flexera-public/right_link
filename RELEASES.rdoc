= 6.X.X (RightLink 6.X alpha/beta/release candidate)
...
* Allow users to ssh on server, if rightlink service is stoped.

== Known Limitations

* Windows 2008/2012 and Ubuntu 12.04 operating systems support only 1 network interface at this time.

== Bug fixes

* rs_tag display warning message if empty parameter provided on adding or removing tag.
