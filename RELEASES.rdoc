...
* RightScripts will generate unneccesary log lines about report or error handlers running. These should be ignored.
* RightScripts with UTF8 characters will currently fail to execute.
