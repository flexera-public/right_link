...
* AMQP has been replaced with HTTP in communition between RightLink and RightNet. When setting up private clouds this should simplify firewall configuration.  TBD need link to firewall friendliness document.
