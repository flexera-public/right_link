...
* Remove Chef Dynamic Powershell Provider.
* Update cloustack ohai plugin to provide correct public and private addresses.
* Update softlayer ohai plugin read public ip, private if and public fqdn from Softlayer API.
